module github.com/vogtp/langchaingo
...
//   - import "github.com/vogtp/langchaingo/llms/openai" → only OpenAI-related deps
//   - import "github.com/vogtp/langchaingo/vectorstores/chroma" → only Chroma deps
